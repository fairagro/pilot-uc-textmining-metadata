...
if __name__ == "__main__":
    ...
    output_dir = "/home/s27mhusa_hpc/pilot-uc-textmining-metadata/data/Bonares/output/TextFiles_filtered_df_soil_crop_year_annotated-Llama-3.2-3B"  # Change to the desired output directory path
